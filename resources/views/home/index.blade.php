...
@section('page-content')
    ...
    <div class="hero-wrap" style="background-image: url('{{ asset('foto/bgee.jpg') }}');" data-stellar-background-ratio="0.5">
        <div class=""></div>
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-12 ftco-animate d-flex align-items-end">
                    <div class="text w-100">
                        <h1 class="mb-4" style="text-shadow: #7988de">Selamat Datang Di <br><span>StrideFootwear</span>.
                        </h1>

                        <p><a href="{{ url('home/produkdaftar') }}" class="btn py-2 px-4"
                                style="background-color: #7988de; color: black">Order Sekarang</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center">
                    <img src="{{ asset('foto/bge1.jpg') }}" width="100%" style="border-radius: 10px">
                </div>
                <div class="col-md-6 wrap-about pl-md-5 ftco-animate py-5">
                    <div class="heading-section">
                        <h2 class="mt-4" style="color: black;">StrideFootwear</h2>
                        <p style="color: black;">
                            Kami adalah toko StrideFootwear terkemuka yang menawarkan berbagai jenis sepatu.
                        </p>
                        <p><a href="{{ url('home/tentang') }}" class="btn py-2 px-4"
                                style="background-color: #7988de; color: black">Tentang Kami</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3 d-flex">
                    <div class="intro d-lg-flex ftco-animate">
                        <div class="text">
                            ...
                            <p>Kami menghadirkan desain yang inovatif dan estetis untuk memastikan setiap detail
                                mencerminkan identitas unik Anda.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="intro d-lg-flex ftco-animate">
                        <div class="text">
                            ...
                            <p>Kami hanya menggunakan bahan berkualitas tinggi untuk memastikan daya tahan dan hasil terbaik
                                dalam setiap produk.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="intro d-lg-flex ftco-animate">
                        <div class="text">
                            ...
                            <p>Sesuaikan desain sesuai kebutuhan dan preferensi Anda untuk mendapatkan hasil yang
                                benar-benar unik dan personal.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex">
                    <div class="intro d-lg-flex ftco-animate">
                        <div class="text">
                            ...
                            <p>Transaksi Anda terlindungi dengan sistem pembayaran yang aman dan terpercaya untuk kenyamanan
                                maksimal.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="product-card">
                            ...
                            <a href="{{ url('home/detail/' . $product->idproduk) }}" class="btn"
                                style="background-color: #7988de">Lihat
                                Detail</a>
                        </div>
                    </div>
                @endforeach
