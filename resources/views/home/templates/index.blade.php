...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-danger ftco_navbar bg-white ftco-navbar-light" id="ftco-navbar"">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ url('') }}" style="color: #7988de">
                StrideFootwear
            </a>
                    ...
                    @else
                        <li class="nav-item active ml-2">
                            <a href="{{ url('home/login') }}" class="nav-link btn py-2 px-3 mt-3"
                                style="background-color: #7988de; color: black !important;">Masuk</a>
                        </li>
                        <li class="nav-item active">
                            <a href="{{ url('home/daftar') }}" class="nav-item nav-link btn py-2 px-2 mt-3 ml-3"
                                style="background-color: white; color: black !important; border: solid #DE7996 1px;">Daftar</a>
                        </li>
                    @endif
                </ul>
            </div>
            ...
            <div class="row py-3">
                <div class="col-md-2">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <h3>Stride Footwear</h3>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2" style="color:#DE7996;"> OFFLINE OFFICE</h2>
                        <p style="margin-top: -20px">Alamat : Ngingas, Waru, Sidoarjo, Jawa Timur</p>
                        <p style="margin-top: -20px">Jl. Delta Raya 1 No.30 </p>
                        <p>Telepon : </p>
                        <p style="margin-top: -20px"> (1234) 456789</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2" style="color:#DE7996;">JAM OPERASIONAL :</h2>
                        <p>Senin - Kamis :</p>
    ...
    <footer style="background-color: #7988de;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center mt-3" style="color: #000">
                    <p>Copyright © 2023 StrideFootwear | All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
