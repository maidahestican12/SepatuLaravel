...
<head>
    ...
    <title>TOKO SEPATU - {{ session('admin')->level }}</title>
    ...
    <style>
        ...
        .dropdown-menu .dropdown-item:active {
            ...
            color: #fff;
            border: 1px solid #DE7996 !important;
            /* Warna teks saat hover atau aktif */
        }

        .alerts-header {
            background-color: #7988de !important;
            /* Warna Coklat */
    ...
    <div id="wrapper">
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #222D32;">
            <a class="sidebar-brand d-flex align-items-center justify-content-center text-white"
                style="background-color: #f3658d" href="{{ url('admin') }}">
                <div class="sidebar-brand-text mx-3">TOKO SEPATU</sup></div>
            </a>
            ...
            @if (session('admin')->level == 'Admin')
                ...
                <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ url('admin/kurir') }}">
                        <i class="fas fa-fw fa-users text-white"></i>
                        <span>Data Kurir</span></a>
                </li>
            @endif
            @if (session('admin')->level == 'Kurir')
                <hr class="sidebar-divider">
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ url('admin/pembeliankurir') }}">
                        <i class="fas fa-fw fa-home text-white"></i>
                        <span>Transaksi</span></a>
                </li>
            @endif
