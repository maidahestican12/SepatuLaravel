                        ...
                        <tbody>
                            ...
                            @foreach ($dataproduk as $dp)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (empty($dp->fotocustom))
                                            <strong><span class="text-center">-</span></strong>
                                        @else
                                            <img src="{{ asset('foto/' . $dp->fotocustom) }}" alt="foto custom"
                                                width="100">
                                        @endif
                                    </td>
                                    <td>{{ $dp->warna }}</td>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form method="post"
                                        ...
                                        <div class="form-group" id="kurirDiv" style="display:none;">
                                            <label>Kurir</label>
                                            <select class="form-control" name="idkurir">
                                                <option value="" selected disabled>Pilih Kurir</option>
                                                @foreach ($kurir as $value)
                                                    <option value="{{ $value->id }}"
                                                        {{ $datapembelian->idkurir == $value->id ? 'selected' : '' }}>
                                                        {{ $value->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
